...
public class SoapReservaExpirationException extends Exception {
	 ...
	 * @param message
	 */
	public SoapReservaExpirationException(String message,
	 ...
	 */
	public SoapReservaExpirationException(String message,
			SoapReservaExpirationExceptionInfo faultInfo, Throwable cause) {
		super(message, cause);
		this.faultInfo = faultInfo;
	}
	...
	/**
	 * 
	 * @return returns fault bean: es.udc.ws.app.client.service.soap.wsdl.
	 *         SoapReservaExpirationExceptionInfo
	 */
