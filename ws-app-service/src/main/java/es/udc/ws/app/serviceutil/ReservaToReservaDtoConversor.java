...
public class ReservaToReservaDtoConversor {
	 ...
	 public static List<ReservaDto> toReservaDtos(List<Reserva> reservas) {
	    ...
	    public static ReservaDto toReservaDto(Reserva reserva) {
	        return new ReservaDto(reserva.getReservaId(), reserva.getOfertaId(), reserva.getEmailUsuarioReserva(),
                    reserva.getTarjetaCreditoReserva(), reserva.getEstadoReserva());
	    }
	    
	    
	    public static Reserva toReserva(ReservaDto reserva) {
	        return new Reserva(reserva.getReservaId(), reserva.getOfertaId(), reserva.getEmailUsuarioReserva(),
                    reserva.getTarjetaCreditoReserva(), reserva.getEstadoReserva(), Calendar.getInstance());
	    }   
